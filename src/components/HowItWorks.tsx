    ...
    return (
        <section id="howitworks">
            <div>
                ...
                {/* Laptop and 4K view */}
                <div className="hidden lg:block bg-white text-darkCharcoal font-poppins py-14">
                    <h1 className="text-4xl font-semibold text-center xl:text-5xl xl:pt-5" data-aos="fade">How It Works</h1>
                    <div className="w-24 h-1 bg-orangered mx-auto rounded mt-2" data-aos="fade"></div>
                    <p className="mt-4 text-center text-lg px-4 py-4 xl:text-xl xl:pb-7">
                        With PreQursor, joining e-sports matches has never been easier.
                    </p>
                    <div className="py-10 pt-14 px-28 xl:ml-12 xl:pb-16 2xl:ml-40">
                        ...
                        <img
                            src="/images/girlGun.jpeg"
                            alt="Girl with a gun"
                            className="mt-5 ml-[530px] absolute h-72 xl:h-96 xl:mt-4 xl:ml-[780px] 2xl:h-[29rem] 2xl:ml-[1000px]"
                            data-aos="fade"
                        />
                        {/* Step 5 */}
                        <div className="relative flex flex-col  items-center bg-[#2C2C2C] p-6 rounded-xl shadow-lg text-white max-w-sm mt-10 pb-10 xl:max-w-lg xl:py-16 2xl:max-w-xl" data-aos="fade-right">
