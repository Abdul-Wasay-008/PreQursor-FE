...
//     const [isUpdating, setIsUpdating] = useState(false); // Track whether we are updating
...
//                 const existingGameId = data[selectedGame]; // Get the ID for the selected game
//                 if (existingGameId) {
//                     setGameId(existingGameId);
//                     setIsUpdating(true); // Set to true if we have an ID
//                 }
//             } catch (error) {
...
//         fetchGameId();
//     }, [userId, token, selectedGame]); // Fetch ID when userId, token, or selectedGame changes
...
//             // Reset game ID to an empty string only if adding a new one
//             if (!isUpdating) {
//                 setGameId(""); // Reset only if we were adding a new ID
//             }
//         } catch (error) {
...
//                             {isUpdating ? "Update" : "Add"} {/* Change button text based on state */}
//                         </button>
//                     </div>
//                 </form>
//             </div>
